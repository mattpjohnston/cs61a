    ...
    def report(self) -> str:
        ...
        if self.changed():
            if self.before > self.after:
                ...
                prefix = "increased"
            msg = f"{prefix} {self.before}->{self.after}"
...
class BankAccount:
    ...
    def deposit(self, amount: int) -> int:
        ...
        """
        transaction = Transaction(self.next_id, self.balance, self.balance + amount)
        self.next_id += 1
    ...
    def withdraw(self, amount: int) -> int | str:
        ...
        if amount > self.balance:
            transaction = Transaction(self.next_id, self.balance, self.balance)
            self.next_id += 1
            self.transactions.append(transaction)
...
class Mint:
    ...
    def update(self) -> None:
        self.year = type(self).present_year
...
class Coin:
    ...
    def worth(self) -> int:
        ...
        extra_cents = age - 50
        return self.cents + extra_cents if extra_cents > 0 else self.cents

...
def roll_dice(num_rolls, dice=six_sided):
    ...
    # BEGIN PROBLEM 1
    total, rolls_so_far, rolled_one = 0, 0, False
...
def sus_points(score):
    ...
    # BEGIN PROBLEM 4
    factors_of_score = num_factors(score)
    if factors_of_score == 3 or factors_of_score == 4:
...
def is_always_roll(strategy, goal=GOAL):
    ...
    # BEGIN PROBLEM 7
    player0, player1 = 0, 0
    initial_roll = strategy(player0, player1)
    while player0 < goal:
        player1 = 0
        while player1 < goal:
            if strategy(player0, player1) != initial_roll:
                return False
            player1 += 1
        player0 += 1
    return True
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    boar_roll = boar_brawl(score, opponent_score)
    if boar_roll >= threshold:
        return 0
    return num_rolls
    # END PROBLEM 10
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    Suss Fuss rules."""
    # BEGIN PROBLEM 11
    score_after_roll_0 = sus_update(0, score, opponent_score)
